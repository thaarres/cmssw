...
from PhysicsTools.JetMCAlgos.CA8PFJetsMCPUJetID_cff import *
process.selectedCA8PFGenJets = ca8GenJetsMCPUJetID.clone()
process.matchedCA8PFGenJets = ca8PFJetsGenJetMatchMCPUJetID.clone()
process.matchedCA8PFGenJets.matched = cms.InputTag("selectedCA8PFGenJets")

#JTA for your jets
from RecoJets.JetAssociationProducers.j2tParametersVX_cfi import *
process.myca8JetTracksAssociatorAtVertex = cms.EDProducer("JetTracksAssociatorAtVertex",
                                                  j2tParametersVX,
...
process.impactParameterTagInfos.jetTracks = cms.InputTag("myca8JetTracksAssociatorAtVertex")
...
from PhysicsTools.JetMCAlgos.CA8PFJetsMCFlavourInfos_cfi import ca8JetFlavourInfos
process.jetFlavourInfosCA8PFJets = ca8JetFlavourInfos.clone()
process.jetFlavourInfosCA8PFJets.jets = cms.InputTag("ca8PFJets")
...
"jetPt","trackJetPt","jetEta","vertexCategory","trackSip2dSig","trackSip3dSig","trackSip2dVal","trackSip3dVal","trackPtRel","trackPPar","trackDeltaR","trackPtRatio","trackPParRatio","trackJetDist","trackDecayLenVal","trackSip2dSigAboveCharm","trackSip3dSigAboveCharm","trackSumJetEtRatio","trackSumJetDeltaR","jetNTracks","trackSip2dValAboveCharm","trackSip3dValAboveCharm","chargedHadronEnergyFraction","neutralHadronEnergyFraction","photonEnergyFraction","electronEnergyFraction","muonEnergyFraction","chargedHadronMultiplicity","neutralHadronMultiplicity","photonMultiplicity","electronMultiplicity","muonMultiplicity","hadronMultiplicity","hadronPhotonMultiplicity","totalMultiplicity"
	...
	jetFlavourMatching = cms.InputTag("jetFlavourInfosCA8PFJets"),
	matchedGenJets = cms.InputTag("matchedCA8PFGenJets"),
	ignoreFlavours = cms.vint32(0)
)

process.p = cms.Path(
process.selectedCA8PFGenJets*
process.matchedCA8PFGenJets *
process.inclusiveVertexing * 
#process.inclusiveMergedVerticesFiltered * 
#process.bToCharmDecayVertexMerged * 
process.myca8JetTracksAssociatorAtVertex * 
process.impactParameterTagInfos * 
process.inclusiveSecondaryVertexFinderTagInfos *
process.selectedHadronsAndPartons *
process.jetFlavourInfosCA8PFJets *
