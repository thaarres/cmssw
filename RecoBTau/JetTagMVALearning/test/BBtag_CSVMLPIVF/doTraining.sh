...
path_to_rootfiles=/afs/cern.ch/user/t/thaarres/CSVTraining/CMSSW_5_3_14/src/RecoBTau/JetTagMVALearning/test/rootfiles/Graviton_BvsBB/
...
Combinations="NoVertex_B_BB NoVertex_B_C PseudoVertex_B_BB PseudoVertex_B_C RecoVertex_B_BB RecoVertex_B_C"
CAT="Reco Pseudo No"
prefix="CombinedSVV2"
...
# 
# #files=("MVATrainer_No_B_BB_cfg.py" "MVATrainer_No_B_C_cfg.py" "MVATrainer_Pseudo_B_BB_cfg.py" "MVATrainer_Pseudo_B_C_cfg.py" "MVATrainer_Reco_B_BB_cfg.py" "MVATrainer_Reco_B_C_cfg.py")
# files=("MVATrainer_Reco_B_BB_cfg.py")
# 
# l=0
# while [ $l -lt  ]
# do
...
# CombinationsArray=("NoVertex_B_BB" "NoVertex_B_C" "PseudoVertex_B_BB" "PseudoVertex_B_C" "RecoVertex_B_BB" "RecoVertex_B_C")
# l=0
# while [ $l -lt 6 ]
# do
# 	jobsrunning=0
