...
process.BTauMVAJetTagComputerRecord = cms.ESSource("PoolDBESSource",
	...
	connect = cms.string("sqlite_file:/afs/cern.ch/user/t/thaarres/removeMe/CMSSW_5_3_14/src/RecoBTau/JetTagMVALearning/test/MVAJetTags_AllwBias010714.db"),
...
process.DQMoutput = cms.OutputModule("PoolOutputModule",
  ...
  fileName = cms.untracked.string('DQMfile_AllwBias010714.root'),
